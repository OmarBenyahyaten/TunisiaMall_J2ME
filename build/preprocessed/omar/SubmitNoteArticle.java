 ...
 * @author omarblythe
 */
class SubmitNoteArticle extends Form implements Runnable,CommandListener{
    HttpConnection hc;
    DataInputStream dis;
...
int idUser=Login.exam.id;
    ...
    public SubmitNoteArticle(int idArticle,int star) {
        super("");
...
String url="http://127.0.0.1/parsing/insertNoteArticle.php?note=" +star+ "&user=" +idUser+"&article="+idArticle;
