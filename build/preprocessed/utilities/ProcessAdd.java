 ...
 * @author timoumi med hedi
 */
public class ProcessAdd implements Runnable {
    ...
    public ProcessAdd(CreateAccount MIDlet, String login,String pass,String mail ,String tel) {
        this.login = login;
        this.mail=mail;
        this.tel=tel;
        this.pass=pass;
    ...
    private void transmit() throws IOException, InterruptedException, ParserConfigurationException, SAXException {
        ...
        try {
            String result = q.postMethodAdd("http://127.0.0.1/parsing/ajoutUser.php",login,pass,mail,tel);
