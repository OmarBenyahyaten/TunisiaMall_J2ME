 ...
 * @author omarblythe
 */
class DeleteLikeArticle extends Form implements Runnable,CommandListener{
    HttpConnection hc;
    DataInputStream dis;
...
int idUser=Login.exam.id;
    ...
    public DeleteLikeArticle(int idArticle) {
        super("");
...
String url="http://127.0.0.1/parsing/deleteLikeArticle.php?user=" +idUser+"&article="+idArticle;
            ...
            if ("o".equalsIgnoreCase(sb.toString().trim())) {
